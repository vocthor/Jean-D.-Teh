...
let main () =
  ...
  Printf.printf "use std::collections::HashMap;\n";
  Printf.printf "use std::io;\n\n";
  Printf.printf "fn main() {\n";
  Printf.printf "\tlet mut stack : Vec<i32> = Vec::new();\n";
  Printf.printf "\tlet mut memory: HashMap<i32, i32> = HashMap::new();\n\n";
