...
fn STSSSSTT(stack: &mut Vec<i32>, memory: &mut HashMap<i32, i32>) {
    // label
...
fn STSSSTST(stack: &mut Vec<i32>, memory: &mut HashMap<i32, i32>) {
    // label
    stack.pop(); // discard
    process::exit(0); // end prog
    STTSSSSTSTTSSTSSSTTSSTSS(stack, memory);
}
fn STTSSSSTSTTSSTSSSTTSSTSS(stack: &mut Vec<i32>, memory: &mut HashMap<i32, i32>) {
    // label
    let a = stack.pop().unwrap();
    let b = stack.pop().unwrap();
    stack.push(b + a); // add
...
fn STTTSTTTSTTTSSTSSTTSTSSTSTTTSTSSSTTSSTST(stack: &mut Vec<i32>, memory: &mut HashMap<i32, i32>) {
    // label
    let n = stack.pop().unwrap();
    stack.push(n);
    stack.push(n); // dup
...
fn STTTSTTTSTTTSSTSSTTSTSSTSTTTSTSSSTTSSTSTSTSTTTTTSTTSSTSTSTTSTTTSSTTSSTSS(
    stack: &mut Vec<i32>,
...
fn STTTSSTSSTTSSTSTSTTSSSSTSTTSSTSS(stack: &mut Vec<i32>, memory: &mut HashMap<i32, i32>) {
    // label
    let n = stack.pop().unwrap();
    stack.push(n);
    stack.push(n); // dup
...
fn STTTSSTSSTTSSTSTSTTSSSSTSTTSSTSSSTSTTTTTSTTSSTSTSTTSTTTSSTTSSTSS(
    stack: &mut Vec<i32>,
    memory: &mut HashMap<i32, i32>,
) {
    // label
...
fn STTSTTTSSTTSSTSTSTTTSTTTSTTSTTSSSTTSTSSTSTTSTTTSSTTSSTST(
    stack: &mut Vec<i32>,
    memory: &mut HashMap<i32, i32>,
) {
    // label
